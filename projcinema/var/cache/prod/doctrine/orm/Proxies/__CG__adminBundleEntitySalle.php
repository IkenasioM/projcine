 ...
 */
class Salle extends \adminBundle\Entity\Salle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'adminBundle\\Entity\\Salle' . "\0" . 'id', '' . "\0" . 'adminBundle\\Entity\\Salle' . "\0" . 'nomsalle', '' . "\0" . 'adminBundle\\Entity\\Salle' . "\0" . 'cinema', '' . "\0" . 'adminBundle\\Entity\\Salle' . "\0" . 'capacite'];
        }
