 ...
 */
class Film extends \adminBundle\Entity\Film implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'adminBundle\\Entity\\Film' . "\0" . 'id', '' . "\0" . 'adminBundle\\Entity\\Film' . "\0" . 'titre', '' . "\0" . 'adminBundle\\Entity\\Film' . "\0" . 'resume', '' . "\0" . 'adminBundle\\Entity\\Film' . "\0" . 'duree'];
        }
