...
class Salle extends \AppBundle\Entity\Salle implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Salle' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Salle' . "\0" . 'nomsalle', '' . "\0" . 'AppBundle\\Entity\\Salle' . "\0" . 'capacite', '' . "\0" . 'AppBundle\\Entity\\Salle' . "\0" . 'cinema'];
        }
