...
class Film extends \AppBundle\Entity\Film implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Film' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Film' . "\0" . 'titre', '' . "\0" . 'AppBundle\\Entity\\Film' . "\0" . 'resume', '' . "\0" . 'AppBundle\\Entity\\Film' . "\0" . 'duree'];
        }
